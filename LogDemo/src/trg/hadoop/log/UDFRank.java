...
value = "_FUNC_(key1, key2, ...) - Number rows starting at 1.  " +
		"Whenever the value of any key changes the numbering is reset to 1.")

public class UDFRank extends UDF {
	Object[] previous_keys = null;	  int previous_index;
